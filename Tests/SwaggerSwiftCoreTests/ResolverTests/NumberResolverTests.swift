...
class NumberResolverTests: XCTestCase {
    ...
    func testUnsupportedIntFormatResolvesToInt() throws {
        let type = NumberResolver.resolve(format: .unsupported("int"), defaultValue: nil, serviceName: "123")
    ...
    func testUnsupportedIntegerFormatResolvesToInt() throws {
        let type = NumberResolver.resolve(format: .unsupported("integer"), defaultValue: nil, serviceName: "123")
    ...
    func testUnsupportedInt64FormatResolvesToInt64() throws {
        let type = NumberResolver.resolve(format: .unsupported("int64"), defaultValue: nil, serviceName: "123")
    ...
    func testUnsupportedFloat64FormatResolvesToDouble() throws {
        let type = NumberResolver.resolve(format: .unsupported("float64"), defaultValue: nil, serviceName: "123")
    ...
    func testUnsupportedDecimalFormatResolvesToDouble() throws {
        let type = NumberResolver.resolve(format: .unsupported("decimal"), defaultValue: nil, serviceName: "123")
    ...
    func testUnsupportedFormatResolvesToDouble() throws {
        let type = NumberResolver.resolve(format: .unsupported("myNonExistingFormat"), defaultValue: nil, serviceName: "123")
