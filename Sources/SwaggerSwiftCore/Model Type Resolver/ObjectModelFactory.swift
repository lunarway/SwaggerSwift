...
public class ObjectModelFactory {
    ...
    func make(properties: [String: Node<Schema>], requiredProperties: [String], allOf: [Node<Schema>]?, swagger: Swagger, typeNamePrefix: String, schema: Schema, namespace: String, customFields: [String: String]) -> (TypeType, [ModelDefinition]) {
        ...
        if let allOf = allOf, allOf.count > 0 {
            let allOfParts: [AllOfPart] = parseAllOf(allOf: allOf,
                                                     typeName: typeName,
                                                     namespace: namespace,
                                                     swagger: swagger)
            ...
            let (resolvedProperties, inlineModels) = resolveProperties(properties: properties,
    ...
    private func resolveProperties(properties: [String: Node<Schema>], withRequiredProperties requiredProperties: [String], namespace: String, swagger: Swagger) -> ([ModelField], [ModelDefinition]) {
    ...
    private func resolveProperty(named: String, namespace: String, schemaNode: Node<Schema>, withRequiredProperties requiredProperties: [String], swagger: Swagger) -> (ModelField, [ModelDefinition])? {
    ...
    private func parseAllOf(allOf: [Node<Schema>], typeName: String, namespace: String, swagger: Swagger) -> [AllOfPart] {
        ...
        for allOf in allOf {
            ...
            case .node(let schema):
                ...
                for property in properties {
                    if let (field, inlineModels) = parseAllOfPartProperty(named: property.key,
    ...
    private func parseAllOfPartProperty(named name: String, propertySchema: Node<Schema>, requiredProperties: [String], namespace: String, swagger: Swagger) -> (ModelField, [ModelDefinition])? {
