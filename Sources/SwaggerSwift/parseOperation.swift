            ...
            case .query(type: let type, allowEmptyValue: _):
                ...
                case .string(format: let format, enumValues: _, maxLength: _, minLength: _, pattern: _):
                    if let format = format {
                        switch format {
                        case .int32:
                            return QueryElement(fieldName: $0.name, fieldValue: $0.name, isOptional: $0.required == false)
                        case .long:
                            return QueryElement(fieldName: $0.name, fieldValue: $0.name, isOptional: $0.required == false)
                        case .float:
                            return QueryElement(fieldName: $0.name, fieldValue: $0.name, isOptional: $0.required == false)
                        ...
                        case .boolean:
                            return QueryElement(fieldName: $0.name, fieldValue: $0.name, isOptional: $0.required == false)
                        case .date:
                            return QueryElement(fieldName: $0.name, fieldValue: "ISO8601DateFormatter().string(from: \($0.name))", isOptional: $0.required == false)
                        case .dateTime:
                            return QueryElement(fieldName: $0.name, fieldValue: "ISO8601DateFormatter().string(from: \($0.name))", isOptional: $0.required == false)
                        case .password:
                            return QueryElement(fieldName: $0.name, fieldValue: $0.name, isOptional: $0.required == false)
